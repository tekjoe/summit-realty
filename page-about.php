      ...
      <div class="row gap-5">
        <div class="col col-60">
          <div class="about__title">
            <span class="subtitle">we go the extra mile</span>
            <h2>Experience the Summit Effect</h2>
          </div>
          <p>Summit Realty was founded in 1991 by Diane McGeen. Summit Realty operates much like a "boutique"
            operation.
            While one can choose to "shop" at the "mega-stores", it often lacks the personal service and flexibility
            that
            a
            "boutique" operation can offer. What prohibits many people from taking advantage of that quality and level
            of
            service is price. The good news is that you can get the best service in a real estate transaction....
            Without
            having to pay exclusive rates!</p>
          <p>When a Broker is not available, we have a great Office Assistant, Aimee, who is happy to assist you any
            way
            she
            can and see that things are handled in a timely manner.</p>
          <p>Summit Realty is also an industry leader in keeping abreast of the technological advances to enhance
            every
            real
            estate transaction. Our exclusive 'mobile office' utilizes the latest in software programs, including real
            estate forms, comparable marketing information, demographic information, mapping capabilities and
            scheduling
            abilities. Because the average Real Estate consumer is technologically savvy, we believe it is our
            position to
            stay at least one step ahead of our customer in order to better meet their needs.</p>
        </div>
        <div class="col col-40 is-centered">
    ...
    <div class="container">
      <div class="row row-wrap gap-2">
        <div class="col col-100">
          <div class="about__title">
            <span class="subtitle">industry leaders</span>
            <h2>Meet our Agents</h2>
          </div>
        </div>
        <div class="col col-50">
          <div class="agent">
            <div class="agent__image"><img
                src="<?php echo get_template_directory_uri() . '/images/';?>hannah-kruis-square.png"
                alt="Diane McGeen" /></div>

            <div class="agent__description">
              <h4>Diane McGeen</h4>
              <p><em>kevin@summitrealty.org</em></p>
              <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Facilisis dictum sit nec tellus. Id quam
                convallis gravida eu posuere sed adipiscing. Libero sed at velit.</p>
              <p>262-555-5555</p>
