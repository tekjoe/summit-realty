    ...
    <div class="intro__body">
      ...
      <div class="amenities">
        ...
        <div class="square-footage">
          <div class="data">
            <?php
        $value = get_field('square_footage');
        if ($value) {
            echo $value;
        } else {
            echo "–";
    ...
    <div class="container">
      <div class="details">
        ...
        if ($value) {
            ...
            echo "No description provided. Please check back later";
        }
        ?>
          </p>
          ...
          <div class="description__details">
            ...
            <div class="description__features">
              <h3>Details</h3>
              <ul>
                <li><strong>Price: </strong>$<?php echo the_field('price'); ?></li>
                <li><strong>Year Built: </strong><?php echo the_field('year_built'); ?></li>
                <li><strong>Square Footage: </strong><?php echo the_field('square_footage'); ?>
                <li>
                <li><strong>Bedrooms: </strong><?php echo the_field('beds'); ?></li>
                <li><strong>Baths: </strong><?php echo the_field('baths'); ?></li>
                <li><strong>Floors: </strong><?php echo the_field('floors'); ?></li>
                <li><strong>Parking: </strong><?php echo the_field('parking'); ?></li>
                <li><strong>Lot Size: </strong><?php echo the_field('lot-size'); ?></li>
              </ul>
            </div>
          </div>
        </div>
        <?php
        $listingAgent = get_field("listing_agent");
        if ($listingAgent): ?>
        <div class="listing-agent">
          <?php if ($listingAgent['display_name'] === "Kevin Kruis"): ?>
          <img src="<?php echo get_template_directory_uri() . '/images/';?>kevin-kruis.png"
            alt="Listing Agent Avatar" />
          <?php elseif ($listingAgent['display_name'] === "Hannah Kruis"): ?>
          <img src="<?php echo get_template_directory_uri() . '/images/';?>hannah-kruis.png"
            alt="Listing Agent Avatar" />
          <?php endif ?>
          <div class="listing-agent__description">
            <h4><?php echo $listingAgent['display_name']; ?></h4>
            <p><em><?php echo $listingAgent['user_email']; ?></em></p>
            <p>262-548-3049</p>
            <div class="listing-agent__contact">
              <a href="https://www.linkedin.com/company/summit-realty-waukesha/about/"><svg width="40" height="40"
              ...
              <a href="mailto:<?php echo $listingAgent['user_email']; ?>"><svg width="40" height="40"
                  viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path fill-rule="evenodd" clip-rule="evenodd"
